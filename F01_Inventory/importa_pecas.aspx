<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="importa_pecas.aspx.vb" Inherits="BD_Pecas.importa_pecas" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <t <title>LR-ERP - Import Part No. to System</title>
    <style type="text/css">
...
<body style="height: 295px">
    ...
    <div style="width: 913px">
        ...
        <asp:Button ID="botao_fechar" runat="server" Text="Close" Width="137px"  />
         ...
         <span style="color: #6600cc; font-family: Trebuchet MS"><strong class="auto-style2"><span class="auto-style2">Import data to inventory System<br />
