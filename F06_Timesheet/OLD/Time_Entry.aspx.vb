...
Public Class Time_Entry
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            label_data.Text = Now.ToString("dd/MM/yyyy")
            'caixa_data.Text = Now.ToString("dd/MM/yyyy")
    ...
    Protected Sub botao_salvar_Click(sender As Object, e As ImageClickEventArgs) Handles botao_salvar.Click
        If (caixa_description_insere.Text) = "" Or (drop_activity_insere.SelectedValue) = "Select an Activity" Or
       (drop_job_insere.SelectedValue) = "Select the Job No." Or (label_data.Text) = "" Or (caixa_hours_insere.Text) = "" Or
    ...
    Public Sub Bind_drop_job_insere()
        ...
        Dim SQL As String = "SELECT [ORDEM_DE_SERVIÇO] FROM [OS] WHERE [ORDEM_DE_SERVIÇO] <> 'Overhead'  AND [ORDEM_DE_SERVIÇO] <> 'R&D' ORDER BY [ORDEM_DE_SERVIÇO] ASC"
    ...
    Protected Sub botao_listar_tarefas_Click1(sender As Object, e As ImageClickEventArgs) Handles botao_listar_tarefas.Click
    ...
    Public Sub Bind_todas_datas()
        ...
        Dim SQL As String = "SELECT * FROM [TIME_TRACKER] WHERE [EMPLOYEE] ='" + Request.ServerVariables("LOGON_USER") + "'" + filtro_os + filtro_atividade + " ORDER BY [DATA] ASC"
    ...
    Public Sub Bind_data_especifica()
        ...
        Dim SQL As String = "SELECT * FROM [TIME_TRACKER] WHERE [EMPLOYEE] ='" + Request.ServerVariables("LOGON_USER") + "'" + " And [Data] BETWEEN #" + data_inicial + "# And #" _
    ...
    Public Sub Bind_hoje()
        ...
        Dim SQL As String = "SELECT * FROM [TIME_TRACKER] WHERE [EMPLOYEE] ='" + Request.ServerVariables("LOGON_USER") + "' AND [DATA] = #" + data_hoje + "#" _
    ...
    Protected Sub botao_calendario_insere_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles botao_calendario_insere.Click

        If Request.Browser.IsMobileDevice Then

            calendario_filtro.Visible = True
    ...
    Protected Sub gdv_time_entry_RowEditing(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewEditEventArgs) Handles gdv_time_entry.RowEditing
        ...
        selected_drop_job_gdv = CType(gdv_time_entry.Rows(e.NewEditIndex).FindControl("job_no__cust_i"), Label).Text
    ...
    Public Sub gera_relatorio()
        ...
        Else
            ...
            Dim jscript As String
            jscript = "<script>window.open('~/F06_Timesheet/report_time_tracker.aspx', '', 'width=1500, height=700, scrollbars=yes')</script>"
    ...
    Protected Sub calendario_filtro_SelectionChanged(sender As Object, e As EventArgs) Handles calendario_filtro.SelectionChanged
        ...
        calendario_filtro.Visible = False
    ...
    Protected Sub calendario_filtro_busca_SelectionChanged(sender As Object, e As EventArgs) Handles calendario_filtro_busca.SelectionChanged


        Session.Add("data_calendario", calendario_filtro_busca.SelectedDate)
        ...
        calendario_filtro_busca.Visible = False
