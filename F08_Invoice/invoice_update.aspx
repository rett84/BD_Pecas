<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="invoice_update.aspx.vb" Inherits="BD_Pecas.invoice_update" %>
    ...
    <asp:Panel ID="painel" runat="server" BorderStyle="Solid" Height="288px" Width="516px">
        <table class="auto-style5">
            <tr>
                ...
                <td class="auto-style11">
                    <asp:DropDownList ID="drop_job" runat="server" AutoPostBack="True" Height="18px" Width="100px" Enabled="False">
                    </asp:DropDownList>
                </td>
            ...
            <tr>
                ...
                <td class="auto-style10"><span style="color: #6600cc; font-family: Trebuchet MS"><strong><span lang="pt-br" style="color: #000000; font-size: medium"><span class="auto-style4">
                    <asp:Button ID="botao_save" runat="server" CssClass="button_save" Text="Update Invoice" Width="139px" />
        ...
        <Columns>
            <asp:TemplateField HeaderText="DESCRIPTION">
                <ItemTemplate>
                    <asp:TextBox ID="description_i" runat="server" Height="18px" Width="348px" Text='<%# BIND("DESCRIPTION") %>'></asp:TextBox>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="QTY">
                ...
                <ItemTemplate>
                    <asp:TextBox ID="qty_i" runat="server" Height="18px" Width="80px" Text='<%# BIND("QTY") %>'></asp:TextBox>
                </ItemTemplate>
            ...
            <asp:TemplateField HeaderText="PRICE">
                ...
                <ItemTemplate>
                    <asp:TextBox ID="valor_i" runat="server" Height="18px" Width="80px" Text='<%# BIND("VALOR") %>'></asp:TextBox>
                </ItemTemplate>
