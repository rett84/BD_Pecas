...
Public Class invoice_update
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            drop_job.Items.Add(job)
            drop_job.SelectedValue = 0
        ...
        Dim SQL0 As String = "SELECT *  FROM [INVOICE_ITEMS] WHERE [INVOICE] = " + caixa_invoice.Text
        ...
        ds.Tables("tabela").DefaultView.AddNew()
        ...
        If Not IsPostBack Then
            ...
            For i = (ds.Tables("tabela").DefaultView.Count + 1) To 50
    ...
    Public Sub calcula_valores()
        ...
        For Each row As GridViewRow In gdv.Rows
            ...
            Dim total = FormatNumber((qtde.Text * valor_un.Text), 2)



            'valor total do pedido com ipi
            total_invoice = total_invoice + Double.Parse(total)
            ...
            dt.Rows(row.RowIndex).Item(3) = total
