<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Pagina.Master" CodeBehind="lanc_despesas.aspx.vb" Inherits="BD_Pecas.lanc_despesas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <span style="font-size: 14pt"><span style="color: #000000; font-family: Arial, Helvetica, sans-serif; font-size: medium; font-weight: normal;"><span class="style2"><span style="color: #6600cc; font-family: Trebuchet MS"><strong style="color: #990099; font-family: 'Arial Black'; font-size: large; font-weight: normal; font-style: normal">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
        ...
        <strong style="color: #990099; font-family: 'Arial Black'; font-size: large; font-style: normal">Lançamento de Despesas</strong><strong style="color: #990099; font-family: 'Arial Black'; font-size: large; font-weight: normal; font-style: normal">&nbsp;
    <br />
&nbsp;<br />
<br />
    <strong><span lang="pt-br" style="color: #000000; font-size: medium">
    &nbsp;&nbsp;&nbsp;&nbsp;
    <asp:DropDownList ID="drop_opcao_lanca_desp" runat="server" Height="20px" 
        ...
        <asp:ListItem Value="3">Administrativo Despesas</asp:ListItem>
    </asp:DropDownList>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    </span></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="newStyle2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><br />
    <asp:Panel ID="panel_insere_despesa" runat="server" BorderStyle="Solid" 
    Width="683px" Visible="False" BorderColor="Black">
        <table style="width:100%;">
            ...
            <tr>
                ...
                <td><span style="font-size: 14pt"><span style="color: #000000; font-family: Arial, Helvetica, sans-serif; font-size: medium; font-weight: normal;"><span class="style2"><span style="color: #6600cc; font-family: Trebuchet MS"><strong style="color: #990099; font-family: 'Arial Black'; font-size: large; font-weight: normal; font-style: normal"><span class="newStyle2">
                    <asp:DropDownList ID="drop_despesa" runat="server" CssClass="auto-style8" Height="22px" Width="220px">
...
&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <asp:Panel ID="panel_busca_despesa" runat="server" BorderStyle="Solid" 
        ...
        <br />
            ...
            style="osO; font-family: Arial, Helvetica, sans-serif; font-size: medium;">&nbsp; 
        OS&nbsp;</span><span class="newStyle2" 
            style="osO; font-family: Arial, Helvetica, sans-serif; font-size: medium; font-weight: normal;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
        &nbsp;<asp:DropDownList ID="drop_os_busca" runat="server" CssClass="auto-style8" 
        ...
        <table style="width:91%;">
            <tr>
                <td class="style7">
                    <span style="font-size: 14pt">
                    <span style="color: #000000; font-family: Arial, Helvetica, sans-serif; font-size: medium; font-weight: normal;">
                    <span class="style2"><span style="color: #6600cc; font-family: Trebuchet MS">
                    <strong style="color: #990099; font-family: 'Arial Black'; font-size: large; font-weight: normal; font-style: normal">
                    <span class="newStyle2"><span class="auto-style17"><span class="newStyle2" 
                        style="os; font-family: Arial, Helvetica, sans-serif; font-size: medium; font-weight: normal;">
                    <asp:RadioButtonList ID="radio_filtro_status" runat="server" Font-Bold="True" 
                        ForeColor="Black">
                        <asp:ListItem Selected="True" Value="1">Já Reembolsado</asp:ListItem>
                        <asp:ListItem Value="2">Reembolso Pendente</asp:ListItem>
                        <asp:ListItem Value="3">Pendente de Relatório</asp:ListItem>
                    </asp:RadioButtonList>
                ...
                <td class="style8">
                    <span style="font-size: 14pt">
                    <span style="color: #000000; font-family: Arial, Helvetica, sans-serif; font-size: medium; font-weight: normal;">
                    <span style="color: #6600cc; font-family: Trebuchet MS"><span class="style2">
                    <strong style="color: #990099; font-family: 'Arial Black'; font-size: large; font-weight: normal; font-style: normal">
                    <span class="newStyle2"><span class="auto-style17"><span class="newStyle2" 
                        style="osO; font-family: Arial, Helvetica, sans-serif; font-size: medium; font-weight: normal;">
                    <asp:RadioButtonList ID="radio_filtro_datas" runat="server" AutoPostBack="True" 
                ...
                <td>
                    ...
                    <br />
                    <asp:Label ID="label_inicial" runat="server" Font-Size="Medium" 
                        ForeColor="Black" style="font-size: small" Text="Data Inicial:" Visible="False"></asp:Label>
                    &nbsp;
                    <asp:Label ID="label_data_inicial" runat="server" CssClass="style5" 
                        Font-Bold="True" Font-Names="Arial" Font-Size="Small" ForeColor="Black" 
                        Visible="False"></asp:Label>
                    <asp:ImageButton ID="botao_calendario_inicial" runat="server" 
                        ImageUrl="~/Imagens/calendario.PNG" Visible="False" />
                    <br />
                    <br />
                    <asp:Label ID="label_final" runat="server" Font-Size="Medium" ForeColor="Black" 
                        style="font-size: small" Text="Data Final:" Visible="False"></asp:Label>
                    &nbsp;
                    <asp:Label ID="label_data_final" runat="server" CssClass="style5" 
                        Font-Bold="True" Font-Names="Arial" Font-Size="Small" ForeColor="Black" 
                        Visible="False"></asp:Label>
                    <asp:ImageButton ID="botao_calendario_final" runat="server" 
                        ImageUrl="~/Imagens/calendario.PNG" Visible="False" />
    ...
    <span 
            ...
            style="osO; font-family: Arial, Helvetica, sans-serif; font-size: medium; font-weight: normal;" 
            __designer:mapid="94">&nbsp;
        <span class="newStyle2" __designer:mapid="a0">
        <span class="auto-style17" __designer:mapid="a3">&nbsp;<span class="newStyle3" __designer:mapid="a8">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span></span>
        </span>
        </span></strong>
        </span></span>
    <span class="style2">
    ...
    <asp:GridView ID="gdv_despesas" runat="server" AutoGenerateColumns="False" 
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="OS">
                <EditItemTemplate>
                    <span style="font-size: 14pt">
                    <span style="color: #000000; font-family: Arial, Helvetica, sans-serif; font-size: medium; font-weight: normal;">
                    <asp:DropDownList ID="drop_os_t" runat="server" DataSourceID="access_drop_os" 
                        DataTextField="ORDEM_DE_SERVIÇO" DataValueField="ORDEM_DE_SERVIÇO" 
                        SelectedValue="<%# pega_OS() %>">
                    </asp:DropDownList>
                    <asp:AccessDataSource ID="access_drop_os" runat="server" 
                        DataFile="~/App_Data/BD11.mdb" 
                        SelectCommand="SELECT [ORDEM_DE_SERVIÇO] FROM [OS] ORDER BY [ORDEM_DE_SERVIÇO]">
                    </asp:AccessDataSource>
                    </span></span>
                </EditItemTemplate>
                <ItemTemplate>
                    <asp:Label ID="os_i" runat="server" Text='<%# Bind("OS") %>' 
                        CssClass="auto-style21" Font-Bold="False" Font-Size="Small"></asp:Label>
                </ItemTemplate>
            ...
            <asp:TemplateField HeaderText="DESPESA">
                <EditItemTemplate>
                    ...
                    <strong style="color: #990099; font-family: 'Arial Black'; font-size: large; font-weight: normal; font-style: normal">
                    <span class="newStyle2">
                    <asp:DropDownList ID="despesa_t" runat="server" CssClass="auto-style8" 
                        Height="22px" SelectedValue="<%# pega_despesa() %>" Width="220px">
                        <asp:ListItem>Selecione a Despesa</asp:ListItem>
                        <asp:ListItem>Diária</asp:ListItem>
                        <asp:ListItem>Refeição / Café da Manhã</asp:ListItem>
                        <asp:ListItem>Refeição / Almoço</asp:ListItem>
                        <asp:ListItem>Refeição / Janta</asp:ListItem>
                ...
                <ItemTemplate>
                    <asp:Label ID="despesa_i" runat="server" Text='<%# Bind("DESPESA") %>' 
                        CssClass="auto-style21" Font-Size="Small"></asp:Label>
                </ItemTemplate>
                <ItemStyle Width="180px" />
            </asp:TemplateField>
            <asp:TemplateField HeaderText="DESC._ADICIONAL">
                <EditItemTemplate>
                    <asp:TextBox ID="desc_adicional_t" runat="server" Height="24px" 
                        Text='<%# Bind("DESC_ADICIONAL") %>' Width="318px"></asp:TextBox>
                </EditItemTemplate>
                <ItemTemplate>
                    <span style="font-size: 14pt">
                    <span style="color: #000000; font-family: Arial, Helvetica, sans-serif; font-size: medium; font-weight: normal;">
                    ...
                    <asp:Label ID="desc_adicional_i" runat="server" CssClass="auto-style21" 
                        Text='<%# Bind("DESC_ADICIONAL") %>' Font-Names="Arial" Font-Size="Small"></asp:Label>
                    </span></strong></span></span></span>
                </ItemTemplate>
            ...
            <asp:TemplateField HeaderText="VALOR">
                <EditItemTemplate>
                    ...
                    <asp:TextBox ID="valor_t" runat="server" Text='<%# BIND("VALOR") %>' 
                        CssClass="auto-style4" Height="23px" Width="91px"></asp:TextBox>
                
                </EditItemTemplate>
                <EditItemTemplate>
                    <asp:TextBox ID="valor_t" runat="server" Text='<%# BIND("VALOR") %>' 
                        CssClass="auto-style4" Height="16px" Width="69px"></asp:TextBox>
                </EditItemTemplate>
                <ItemTemplate>
                    <asp:Label ID="valor_i" runat="server" Text='<%# Bind("VALOR") %>' 
                        CssClass="auto-style20" Font-Size="Small"></asp:Label>
                </ItemTemplate>
            ...
            <asp:TemplateField HeaderText="NOTA">
                <EditItemTemplate>
                    <span style="font-size: 14pt">
                    <span style="color: #000000; font-family: Arial, Helvetica, sans-serif; font-size: medium; font-weight: normal;">
                    <asp:TextBox ID="nota_t" runat="server" Text='<%# Bind("NOTA") %>' 
            ...
            <asp:TemplateField HeaderText="DATA">
                <EditItemTemplate>
                    <span style="font-size: 14pt">
                    <span style="color: #000000; font-family: Arial, Helvetica, sans-serif; font-size: medium; font-weight: normal;">
                    <asp:TextBox ID="data_t" runat="server" Height="22px" 
                        Text='<%# Bind("DATA", "{0:dd/MM/yyyy }") %>' Width="128px"></asp:TextBox>
                    </span></span>
                </EditItemTemplate>
                <ItemTemplate>
                    <span style="font-size: 14pt">
            ...
            <asp:TemplateField HeaderText="STATUS">
                <EditItemTemplate>
                    ...
                    <asp:Label ID="status_t" runat="server" CssClass="newStyle17 auto-style20" 
                        Text='<%# Bind("STATUS") %>' Font-Size="Small"></asp:Label>
            ...
            <asp:TemplateField HeaderText="COLABORADOR" Visible="False">
                <EditItemTemplate>
                    ...
                    <asp:Label ID="colaborador_t" runat="server" CssClass="newStyle17 auto-style20" 
                        Text='<%# Bind("COLABORADOR") %>' Font-Size="Small"></asp:Label>
                    </span></span></strong></span></span></span>
                </EditItemTemplate>
                <ItemTemplate>
        ...
        </span><span style="color: #6600cc; font-family: Trebuchet MS"><strong style="color: #990099; font-family: 'Arial Black'; font-size: large; font-weight: normal; font-style: normal"><span class="style2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<table style="width: 54%;">
        <tr>
            <td class="auto-style30">&nbsp;</td>
            <td class="auto-style31">&nbsp;</td>
            <td rowspan="3">    <span style="font-size: 14pt"><span style="color: #000000; font-family: Arial, Helvetica, sans-serif; font-size: medium; font-weight: normal;"><span style="color: #6600cc; font-family: Trebuchet MS"><strong style="color: #990099; font-family: 'Arial Black'; font-size: large; font-weight: normal; font-style: normal"><span class="style2">
        <span class="newStyle2" __designer:mapid="7b"><span class="auto-style17" 
            __designer:mapid="7c"><span class="newStyle2" 
            
            style="osO; font-family: Arial, Helvetica, sans-serif; font-size: medium; font-weight: normal;" 
            __designer:mapid="80"><span class="newStyle3" __designer:mapid="9d">
                    <span class="newStyle2" 
                        
                        style="osO; font-family: Arial, Helvetica, sans-serif; font-size: small; font-weight: bold; font-style: italic;" 
                        __designer:mapid="9e">
                    <asp:ImageButton ID="botao_gera_relatorio" runat="server" Height="45px" 
                        ImageUrl="~/Imagens/relatorio.PNG" Visible="False" 
        Width="127px" />
                    </span></span>
    ...
    <span style="font-size: 14pt"><span style="color: #000000; font-family: Arial, Helvetica, sans-serif; font-size: medium; font-weight: normal;"><span style="color: #6600cc; font-family: Trebuchet MS"><strong style="color: #990099; font-family: 'Arial Black'; font-size: large; font-weight: normal; font-style: normal"><span class="style2">
